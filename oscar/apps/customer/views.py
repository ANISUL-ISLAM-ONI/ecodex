...
class ActivateEmailView(View):
    def get(self, request, uidb64, token):
        try:
            ...
            #    return redirect('customer:login'+'?messages='+'User already activated')
            if user.is_active:
...
class AccountAuthView(RegisterUserMixin, generic.TemplateView):
    ...
    def get_registration_success_message(self, form):
        return _("Thanks for registering! Please activate your account from your email you provided.")
