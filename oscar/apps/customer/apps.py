...
class CustomerConfig(OscarConfig):
    ...
    def ready(self):
        ...
        self.email_activation_view = get_class('customer.views', 'ActivateEmailView')
    ...
    def get_urls(self):
        urls = [
            ...
            path('activate-email/<uidb64>/<token>/', self.email_activation_view.as_view(), name='activate-email'),
